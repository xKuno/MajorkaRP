...
--GENERAL
Config.permission        = "mod" --Permission needed to use ban commands (mod-admin-superadmin)


--WEBHOOK
Config.Discord			 = 'https://discord.gg/SUymZhg'
