...
Citizen.CreateThread(function()
	...
	while true do
		...
		for k,v in pairs(Stores)do
			...
			if(#(pos - vector3(pos2.x, pos2.y, pos2.z)) < 15.0)then
				...
				if not holdingup then
					...
					elseif(#(pos - vector3(pos2.x, pos2.y, pos2.z)) > 1.0) then
						incircle = false
					end
				end
			end
		...
		if holdingup then
							if #(GetEntityCoords(GetPlayerPed(-1)) - vector3(-626.5326, -238.3758, 38.05)) < 0.5 then
							...
							if IsControlJustReleased(1, 51) then
								...
								TriggerServerEvent('esx_vangelico_robbery:dajitemy')
							...
							if #(GetEntityCoords(GetPlayerPed(-1)) - vector3(-625.6032, -237.5273, 38.05)) < 0.5 then
							...
							if #(GetEntityCoords(GetPlayerPed(-1)) - vector3(-626.9178, -235.5166, 38.05)) < 0.5 then
							...
							if #(GetEntityCoords(GetPlayerPed(-1)) - vector3(-625.6701, -234.6061, 38.05)) < 0.5 then
							...
							if #(GetEntityCoords(GetPlayerPed(-1)) - vector3(-626.8935, -233.0814, 38.05)) < 0.5 then
							...
							if #(GetEntityCoords(GetPlayerPed(-1)) - vector3(-627.9514, -233.8582, 38.05)) < 0.5 then
							...
							if #(GetEntityCoords(GetPlayerPed(-1)) - vector3(-624.5250, -231.0555, 38.05)) < 0.5 then
							...
							if #(GetEntityCoords(GetPlayerPed(-1)) - vector3(-623.0003, -233.0833, 38.05)) < 0.5 then
							...
							if #(GetEntityCoords(GetPlayerPed(-1)) - vector3(-620.1098, -233.3672, 38.05)) < 0.5 then
							...
							if (#(GetEntityCoords(GetPlayerPed(-1)) - vector3(-620.2979, -234.4196, 38.05)) < 0.5 ) then
							...
							if (#(GetEntityCoords(GetPlayerPed(-1)) - vector3(-619.0646, -233.5629, 38.05)) < 0.5 ) then
							...
							if (#(GetEntityCoords(GetPlayerPed(-1)) - vector3(-617.4846, -230.6598, 38.05)) < 0.5 ) then
							...
							if (#(GetEntityCoords(GetPlayerPed(-1)) - vector3(-618.3619, -229.4285, 38.05)) < 0.5 ) then
							...
							if (#(GetEntityCoords(GetPlayerPed(-1)) - vector3(-619.6064, -230.5518, 38.05)) < 0.5 ) then
							...
							if (#(GetEntityCoords(GetPlayerPed(-1)) - vector3(-620.8951, -228.6519, 38.05)) < 0.5 ) then
							...
							if (#(GetEntityCoords(GetPlayerPed(-1)) - vector3(-619.7905, -227.5623, 38.05)) < 0.5 ) then
							...
							if (#(GetEntityCoords(GetPlayerPed(-1)) - vector3(-620.6110, -226.4467, 38.05)) < 0.5 ) then
							...
							if (#(GetEntityCoords(GetPlayerPed(-1)) - vector3(-623.9951, -228.1755, 38.05)) < 0.5 ) then
							...
							if (#(GetEntityCoords(GetPlayerPed(-1)) - vector3(-624.8832, -227.8645, 38.05)) < 0.5 ) then
							...
							if (#(GetEntityCoords(GetPlayerPed(-1)) - vector3(-623.6746, -227.0025, 38.05)) < 0.5 ) then
...
RegisterNetEvent("esx_vangelico_robbery:sprzedajegowno")
AddEventHandler("esx_vangelico_robbery:sprzedajegowno", function (count)
	FreezeEntityPosition(GetPlayerPed(-1), true)
	exports['MajorkaRP']:startUI((count * 1000), "KLEJNOTY -> PIENIADZE")
	Citizen.Wait((count * 1000))
	...
	TriggerServerEvent('lester:sprzedalwszystkowpizdu')
	sprzedaje = false
end)
...
Citizen.CreateThread(function()
    while true do
       Citizen.Wait(0)
		if pos then
			if #(pos - vector3(-493.88, -2850.45, 7.3)) <= 5 and not sprzedaje then
				ESX.ShowHelpNotification(_U('press_to_klejnoty'))
				if IsControlJustReleased(1, 51) and not sprzedaje and #(pos - vector3(-493.88, -2850.45, 7.3)) <= 5 then
					TriggerServerEvent('lester:ilema')
					sprzedaje = true
				end	
			end
		end
