...
function OpenAccessoryMenu()
	...
	'default', GetCurrentResourceName(), 'set_unset_accessory',
	{
		...
		elements = {
			...
			{label = 'Kamizelka',   value = 'bproof', value2 = 'bproof', lib = 'skydive@parachute@', anim  = 'chute_off' },
	...
	function(data, menu)
		...
		TriggerEvent('skinchanger:getSkin', function(skin)
			...
			if (_accessory == "helmet" or _accessory == "glasses" or _accessory == "ears" or _accessory == "mask" or _accessory == "bproof")  then
...
Citizen.CreateThread(function()
	while true do
		...
		for k,v in pairs(Config.Zones) do
			for i = 1, #v.Pos, 1 do
				if(Config.Type ~= -1 and #(coords - vector3(v.Pos[i].x, v.Pos[i].y, v.Pos[i].z)) < Config.DrawDistance) then
