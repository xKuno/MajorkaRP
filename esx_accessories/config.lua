...
Config.ShopsBlips = {
	...
	Mask = {
		Pos = { 
			...
			{x = 620.07, y = 2769.16, z = 41.1},
			{x = 117.31, y = -227.27, z = 53.66},
		},
...
Config.Zones = {
	...
	Bproof = {
		Pos = { 
			{ x = 457.02, y = -992.66, z = 29.69 },
			{ x = 151.59, y = -764.14, z = 49.14},
			{ x = 1847.42, y = 3695.04, z = 34.21 - 0.90},
			{ x = -1095.14, y = -830.21, z = 13.28},
			{ x = -1988.23, y = -501.82, z = 19.83},
			{ x = 370.13, y = -1605.37, z = 29.29 - 0.90},
		}
	},
