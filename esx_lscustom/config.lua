...
Config.Zones = {
	...
	ls8Airport = {
		Pos   = { x = -965.41, y = -3005.17, z = 13.95},
		Size  = {x = 10.0, y = 10.0, z = 5.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = ('Plane Los Santos Custom'),
		Hint  = _U('press_custom'),
		IsBlip = true
	},

	ls9Lake = {
		Pos   = { x = -709.89, y = -1337.6, z = 2.08},
		Size  = {x = 10.0, y = 10.0, z = 5.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = ('Ship Los Santos Custom'),
		Hint  = _U('press_custom'),
		IsBlip = true
	},

	ls9 = {
        Pos   = { x = -200.55, y = -1319.35, z = 26.81},
        Size  = {x = 3.0, y = 3.0, z = 0.2},
        Color = {r = 204, g = 204, b = 0},
        Marker= 1,
        Name  = _U('blip_name'),
	...
	ls11 = {
        Pos   = { x = -111.07, y = -1798.14, z = 26.81},
        Size  = {x = 3.0, y = 3.0, z = 0.2},
        Color = {r = 204, g = 204, b = 0},
        Marker= 1,
        Name  = _U('blip_name'),
	...
	ls12 = {
        Pos   = { x = -128.35, y = -1791.95, z = 24.13},
        Size  = {x = 3.0, y = 3.0, z = 0.2},
        Color = {r = 204, g = 204, b = 0},
        Marker= 1,
        Name  = _U('blip_name'),
	...
	ls15 = {
        Pos   = { x = -120.41, y = -1783.86, z = 24.13},
        Size  = {x = 3.0, y = 3.0, z = 0.2},
        Color = {r = 204, g = 204, b = 0},
        Marker= 1,
        Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {4.95, 6.56, 7.12, 12.53}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {2.65, 3.3, 4.6, 7.95}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {2.95, 33.93, 6.51}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {2.72, 3.44, 4.88, 4.77, 7.2}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
