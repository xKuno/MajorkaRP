webpackJsonp([1], [, , , , , , , , , function(t, e, n) {
    ...
    function i(t) {
        ...
        v.locale = "pl_PL", v.locales = {}, t.prototype.$timeago = {
    ...
    var a = n(31),
		...
		"tylko teraz",
        ["mniej niż minuta"],
        ["około minuty", "%s minut"],
        ["około godziny", "około %s godzin"],
        ["około tygodnia", "%s tydzień"],
        ["%s week ago", "%s weeks ago"],
        ["około miesiąca", "%s miesięcy"],
        ["około roku", "%s lat"]
      ]
        }
}, function(t, e, n) {
    ...
    var g = {
        ...
        v = {
            ...
            resetPhone: function(t) {
                var e = t.dispatch,
                    n = t.getters;
                e("setZoon", "100%"), e("setVolume", 1), e("setBackground", n.config.background_default), e("setCoque", n.config.coque_default), e("setSonido", n.config.sonido_default), e("setLanguage", "pl_PL")
            }
        },
        _ = {
