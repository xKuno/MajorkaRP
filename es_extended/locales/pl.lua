Locales['pl'] = {
  ...
  ['gave_weapon'] = 'Dales ~y~1x~s~ ~b~%s~s~ Obywatelowi ~y~%s~s~.',
  ['gave_weapon_ammo'] = 'Dales ~y~1x~s~ ~b~%s~s~ z ~o~%sx~s~ kulami Obywatelowi ~y~%s~s~.',
  ['gave_weapon_hasalready'] = '~y~%s~s~ juz posiada ~y~%s~s~',
  ['received_weapon'] = 'Otrzymales ~y~1x~s~ ~b~%s~s~ od Obywatela ~b~%s~s~.',
  ['received_weapon_ammo'] = 'Otrzymales ~y~1x~s~ ~b~%s~s~ z ~o~%sx~s~ kulami od Obywatela ~b~%s~s~.',
  ['received_weapon_hasalready'] = '~b~%s~s~ probowal dac Ci ~y~%s~s~, lecz juz to masz.',
  ...
  ['threw_standard'] = 'wyrzuciles ~y~%sx~s~ ~b~%s~s~',
  ['threw_money'] = 'wyrzuciles ~r~$%s~s~ ~b~cash~s~',
  ['threw_account'] = 'wyrzuciles ~r~$%s~s~ ~b~%s~s~',
  ['threw_weapon'] = 'wyrzuciles ~y~1x~s~ ~b~%s~s~',
  ['threw_weapon_ammo'] = 'wyrzuciles ~y~1x~s~ ~b~%s~s~ z ~o~%sx~s~ nabojami',
  -- Salary related
  ['received_salary'] = 'otrzymałeś wynagrodzenie: ~g~%s$~s~ z pracy: ~g~%s!~s~',
  ...
  ['received_paycheck2'] = 'otrzymana wypłata',
  ['bank'] = 'bank',
  ...
  ['weapon_pipwerench'] = 'klucz',
  ['weapon_bat'] = 'kij',
  ['weapon_golfclub'] = 'kij golfowy',
  ['weapon_crowbar'] = 'łom',
  ['weapon_pistol'] = 'pistolet',
  ['weapon_snspistolmk2'] = 'pistolet sns mk2',
  ['weapon_pistolmk2'] = 'pistolet mk2',
  ...
  ['weapon_revolver_mk2'] = 'ciężki rewolwer mk2',
