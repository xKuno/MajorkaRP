Locales['en'] = {
  ...
  ['robbery_timer'] = 'Napad: ~r~%s~s~ sekund do końca',
  ['recently_robbed'] = 'Ten obiekt niedawno został obrabowany. Proszę poczekać ~y~%s~s~ sekund przed kolejnym napadem',
  ['recently_robbedcd'] = 'Niedawno został wykonany napad. Proszę poczekać ~y~%s~s~ sekund przed kolejnym rabunkiem.',
  ...
  ['press_to_pendrajf'] = 'Nacisnij ~INPUT_CONTEXT~ aby rozpoczac poszukiwania kupca w sieci~b~.',
  ['copsforsell'] = 'Blad sieci! Musi byc ~b~4 policjantow~s~ w miescie aby rozpoczac poszukiwania kupca.',
}
