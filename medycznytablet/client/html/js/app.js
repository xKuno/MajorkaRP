(function(t) {
    ...
    "066d": function(t, e, n) {
        t.exports = n.p + "img/EMS_logo_GTA_V.png"
    },
    "139d": function(t, e, n) {},
    1428: function(t, e, n) {
        "use strict";
    ...
    1771: function(t, e, n) {
        var i = {
            ...
            "./EMS_logo_GTA_V.png": "8c64",
            "./example-image.jpg": "248e",
            "./EMS_logo_GTA_V.png": "066d",
            "./EMS_logo_GTA_V.png": "bff7",
            "./EMS_logo_GTA_V.png": "4f84"
        };
        ...
        var w = {
            ...
            y = new h["a"].Store({
                ...
                actions: {
                    ...
                    addNewCitizenNoteems: function(t, e) {
                        var n = t.state;
                    ...
                    addNewCitizenConvictionems: function(t) {
                        var e = t.state;
                    ...
                    addNewVehicleNoteems: function(t, e) {
                        var n = t.state;
                ...
                getters: {
                    ...
                    getDepartmentName: function(t) {
                        return t.userData && null != t.departments[t.userData.jobName] ? t.departments[t.userData.jobName].displayName : "Emergency Medical Services"
                    },
                    ...
                    getCitizensWarrantsListems: function(t) {
                        return Object(f["b"])(t.citizensWarrantsList) ? null : t.citizensWarrantsList
                    },
                    getVehiclesWarrantsListems: function(t) {
            ...
            P = {
                ...
                computed: {
                    getHeaderText: function() {
                        return this.isLoggedIn ? "Zalogowany jako: ".concat(this.user.name) : "Zaloguj się aby kontynuować"
                    },
            ...
            E = {
                ...
                methods: {
                    minimize: function() {
                        this.$policeApi.closePoliceMdcems()
                    },
                    quit: function() {
                        console.log("Destroying tablet"), this.$store.commit("SET_USER_DATA", null), this.$router.push("/login"), this.$policeApi.closePoliceMdcems()
                    },
            ...
            Z = function() {
                ...
                return n("b-row", {
                ...
                }, [t._v("\n        Aby dodać nowy fakturę musisz najpierw wyszukać obywatela.\n      ")])], 1) : n("b-col", [n("b-row", [n("b-col", {
                    attrs: {
                        cols: "6"
                    }
                ...
                }, [t._v("+")])], 1)]), t._l(this.convictionPageData.selectedConvictions, function(e, i) {
                    return n("tr", {
                        key: i
                    ...
                    })], 1), n("td", [t._v(t._s(t.calculateFee(e)) + "$")]), n("td", [n("b-button", {
                        attrs: {
                            variant: "danger",
                            size: "sm"
                        },
                ...
                }, [t._v(t._s(t.calculateTotalFee()) + "$")])], 1), ])])])]), n("b-row", [n("b-col", [n("b-form-textarea", {
                    attrs: {
                ...
                }, [t._v("Wystaw Fakturę")])], 1)], 1)], 1)], 1)], 1)], 1)
            },
            U = [],
            $ = (n("6762"), n("2fdb"), n("ac4d"), n("8a81"), n("ac6a"), n("7514"), {
                ...
                methods: {
                    addConviction: function(t) {
                        ...
                        } else this.$bvToast.toast("Nazwa Faktury.", {
                            title: "Wystąpił błąd.",
                            autoHideDelay: 3500,
                            variant: "danger",
                            appendToast: !0
                    ...
                    addNewConviction: function() {
                        ...
                        if (null != t && null != t.name) {
                            ...
                            if (null != e) {
                                ...
                                null == o || o.length <= 0 ? this.$bvToast.toast("Aby kontynuować musisz wybrać przynajmniej jedną fakturę.", {
                                    title: "Wystąpił błąd.",
                                    autoHideDelay: 3500,
                                    variant: "danger",
                                    appendToast: !0
                                }) : (o += this.convictionPageData.convictionsAuthors, this.$policeApi.addNewCitizenConvictionems(t.id, t.name, e.name, o, this.convictionPageData.convictionNote, n, i), this.$store.dispatch("addNewCitizenConvictionems"), this.$router.push({
                                    name: "searchCitizensPage"
                                }))
                        ...
                        } else this.$bvToast.toast("Wystąpił błąd, aby wystawić fakturę trzeba najpierw wyszukać obywatela.", {
                            title: "Wystąpił błąd.",
                            autoHideDelay: 3500,
                            variant: "danger",
                            appendToast: !0
        ...
        var H = K,
            ...
            G = function() {
                ...
                return Object(B["a"])(t, [{
                    ...
                    value: function() {
                        var t = Object(m["a"])(regeneratorRuntime.mark(function t() {
                            ...
                            return regeneratorRuntime.wrap(function(t) {
                                while (1) switch (t.prev = t.next) {
                                    case 0:
                                        return t.next = 2, window.jQuery.get("/configs/config.json");
                                    case 2:
                                        return e = t.sent, console.log("Config repsonse = ".concat(JSON.stringify(e))), n = JSON.parse(e), t.next = 8, y.dispatch("loadConfig", n);
                                    case 8:
                                        t.next = 13;
                                        break;
                                    case 10:
                                        return i = e, t.next = 13, y.dispatch("loadConfig", i);
                                    case 13:
                                    case "end":
                                        return t.stop()
                                }
                    ...
                    key: "closePoliceMdcems",
                    value: function() {
                        y.commit("setPoliceTabletVisible", !1), this.post("closePoliceMdcems")
                    }
                }, {
                    ...
                    key: "addNewCitizenNoteems",
                    value: function() {
                        var t = Object(m["a"])(regeneratorRuntime.mark(function t(e) {
                            return regeneratorRuntime.wrap(function(t) {
                                while (1) switch (t.prev = t.next) {
                                    case 0:
                                        return t.next = 2, this.post("addNewCitizenNoteems", e);
                                    case 2:
                    ...
                    key: "addNewCitizenConvictionems",
                    value: function() {
                            ...
                            return regeneratorRuntime.wrap(function(t) {
                                while (1) switch (t.prev = t.next) {
                                    case 0:
                                        ...
                                        }), this.post("addNewCitizenConvictionems", y.getters.getNewConviction);
                                    case 2:
                                    case "end":
                                        return t.stop()
                                }
                    ...
                    key: "addNewVehicleNoteems",
                    value: function(t) {
                        return this.post("addNewVehicleNoteems", t)
                    }
                }, {
                    key: "getCitizensWarrantsListems",
                    value: function() {
                        var t = this.post("getCitizensWarrantsListems");
                        return "error" != t
                    }
                }, {
                    key: "getVehiclesWarrantsListems",
                    value: function() {
                        var t = this.post("getVehiclesWarrantsListems");
                        return "error" != t
                    }
                }]), t
            }(),
