Locales['pl'] = {
  -- cloakroom
  ['cloakroom_menu'] = '</b style = color:white>Szatnia</b>',
  ['cloakroom_prompt'] = 'naciśnij ~INPUT_CONTEXT~ aby użyć ~y~szatni~s~.',
  ['wear_citizen'] = '</b style = color:white>Strój Cywilny</b>',
  ['wear_work'] = '<b style = color:green>Strój Kuriera</b>',
  ...
  ['only_taxi'] = 'możesz przechowywać tylko pojazdy Adwokackie.',
  ...
  ['deposit_stock'] = 'Weź z Depozytu',
  ['take_stock'] = 'Włóż do Depozytu',
