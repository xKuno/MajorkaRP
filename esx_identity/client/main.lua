...
RegisterNUICallback('register', function(data, cb)
	...
	if reason == "" then
		...
		ESX.ShowNotification(reason.."....")
		ESX.ShowNotification(reason..".....")
		TriggerServerEvent("chuj", reason)
		Citizen.Wait(500)
	end
end)
...
function verifyName(name)
	...
	if nameLength > 25 or nameLength < 2 then
		return 'Nazwa twojej postaci jest za krótka lub za długa.'
	end
	...
	if spacesInName > 2 then
		return 'Nazwa twojej postaci zawiera więcej niż dwie spacje!'
	end
	
	if spacesWithUpper ~= spacesInName then
		return 'Twoje Imię musi zaczynać się wielką literą.'
	end
