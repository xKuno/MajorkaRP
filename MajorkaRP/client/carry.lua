			...
			if IsPlayerDead(closestPlayer) then	
				if closestPlayer then
					...
					if targetSrc ~= -1 then
						...
						TriggerEvent('esx:showNotification', 'Nie ma nikogo w poblizu')
					end
				else
				TriggerEvent('esx:showNotification', 'Nie ma nikogo w poblizu')
				end
			else
			--	ESX.ShowNotification("~r~Nie możesz podnieśc gracza który jest żywy")
				TriggerEvent('esx:showNotification', 'Nie możesz podnieśc gracza który jest żywy')
			end
		else
			TriggerEvent('esx:showNotification', 'Nie możesz tego zrobić będacy martwym')
			--ESX.ShowNotification("~r~Nie możesz tego zrobić będacy martwym")
		end
	else
