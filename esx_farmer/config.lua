...
Config.WheatSellEarnings		  = 150
Config.MilkSellEarnings		      = 30
...
Config.Zones = {
	...
	VehicleSpawner = {
		Pos   = {x = 2023.1076660156, y = 4979.6704101563, z = 41.17578125},
	...
	VehicleSpawnPoint = {
		Pos     = {x = 2022.8967285156, y = 4973.3935546875, z = 41.2431640625},
		Size  = {x = 1.4, y = 1.4, z = 2.0},
		Type    = -1, Rotate = false,
		Heading = 210.10
	},
	...
	VehicleDeleter = {
		Pos   = {x = 2012.5450439453, y = 4970.4921875, z = 40.539663085938},
...
Config.Help = {
	Title = 'POMOC(30s)',
	Text = 'Weź traktor z punktu który jest obok przebieralni, następnie jedź na pole traktorem oznaczony na GPS ~y~"Zbieranie Pszenicy"~s~, gdy zbierzesz wystarczającą ilość udaj się spowrotem do garażu, schowaj traktor weź samochód o nazwie : ~r~Bodhi~g~(Podczas sprzedaży MUSISZ być w tym samochodzie)~s~i jedź do ~y~Piekarni~s~ znajduje się w ~b~Los Santos~s~, okolice urzędniczej. Po tym udaj się do sprzedaży chleba który znajduje się w okolicy Kina.',
	Time = 30,
}
