...
mumbleConfig = {
	...
	voiceModes = {
		{5.0, "Szept"}, -- Whisper speech distance in gta distance units
		{15.0, "Normalny"}, -- Normal speech distance in gta distance units
		{25.0, "Krzyk"}, -- Shout speech distance in gta distance units
	},
