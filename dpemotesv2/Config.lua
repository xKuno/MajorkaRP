...
Config.Languages = {
  ['en'] = {
    ...
    ['favoriteinfo'] = "Wybierz animację tutaj aby ustawić ją jako ulubioną.",
    ['rfavorite'] = "Resetuj Ulubione",
    ['prop2info'] = "❓ Animacje z propami mogą być umieszczone na końcu",
    ['set'] = "Ustaw (",
    ['setboundemote'] = ") być twoją związaną emotką?",
    ['newsetemote'] = "~w~ jest teraz twoją związaną emotką, wciśnij ~g~CapsLock~w~ aby użyć tego.",
    ['cancelemote'] = "Anuluj animacje",
    ['cancelemoteinfo'] = "~r~X~w~ Anuluje obecnie używaną animacje",
    ['walkingstyles'] = "Style chodzenia",
    ['resetdef'] = "Resetuj do domyślnych",
    ['normalreset'] = "Normalny (Resetowanie)",
    ['moods'] = "Nastroje",
    ['infoupdate'] = "Informacje",
    ['infoupdateav'] = "Informacje (Aktualizacja dostępna)",
    ['infoupdateavtext'] = "Aktualizajca jest dostępna, poprzednią wersję znajdziesz tutaj ~y~https://github.com/andristum/dpemotes~w~",
    ['suggestions'] = "Pytania?",
    ['suggestionsinfo'] = "'dullpear_dev' zajrzyj na forum FiveM'a aby uzyskać sugestie dotyczące funckji/emotek! ✉️",
    ['notvaliddance'] = "nie jest prawidłowym tańcem.",
    ['notvalidemote'] = "nie jest prawidłową emotką.",
    ['nocancel'] = "brak emotki do anulowania.",
    ['maleonly'] = "Ta emotka jest wyłącznie dla mężczyzn, przepraszamy!",
    ['emotemenucmd'] = "Szybsze odpalanie poprzez /emotemenu.",
    ['shareemotes'] = "👫 Wspólne animacje",
    ['shareemotesinfo'] = "Zaproś pobliską osobę do animacji",
    ['sharedanceemotes'] = "🕺 Wspólne tańce",
    ['notvalidsharedemote'] = "nie jest prawidłową udostępnianą emotką.",
    ['sentrequestto'] = "Wyślij zaproszenie do ~y~",
    ['nobodyclose'] = "Brak graczy w ~r~pobliżu~w~.",
    ['doyouwanna'] = "~y~Y~w~ aby zaakceptować, ~r~L~w~ aby odmówić (~g~",
    ['refuseemote'] = "Odmówiono.",
    ['makenearby'] = "powoduje, że gracz w pobliżu gra",
    ['camera'] = "Naciśnij ~y~G~w~ aby używać lampy błyskowej aparatu.",
    ['makeitrain'] = "Naciśnij ~y~G~w~ żeby padał deszcz.",
    ...
    ['notvalidkey'] = "nie jest prawidłowym przyciskiem.",
    ['keybinds'] = "🔢 Keybinds",
    ['keybindsinfo'] = "Use"
  },
  ['fr'] = {
