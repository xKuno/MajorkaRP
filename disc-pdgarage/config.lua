...
Config.AmbulanceDataBaseName = 'ambulance'	-- set the exact name from your jobs database for police
Config.MecanoDataBaseName = 'mecano'	-- set the exact name from your jobs database for police
...
Config.PoliceExtraMarkerScale = { x = 4.5, y = 4.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.ExtraDraw3DText = "Naciśnij ~g~[E]~s~ aby otworzyć ~y~menu dodatków~s~"		-- set your desired text here
...
-- Menu Labels & Titles:
Config.LabelStoreVeh = "Sprzedaj pojazd"
Config.LabelGetVeh = "Weź pojazd"
Config.LabelPrimaryCol = "Pierwsze malowanie"
Config.LabelSecondaryCol = "Drugie malowanie"
Config.LabelExtra = "Extra Menu"
Config.LabelLivery = "Malowania"
Config.TitlePoliceGarage = "Policyjny garaż"
Config.TitlePoliceExtra = "Extra Menu"
Config.TitlePoliceLivery = "Malowania"
Config.TitleColorType = "Color Type"
Config.TitleValues = "Value"

-- ESX.ShowNotifications:
Config.VehicleParked = "~b~Pojazd został zaparkowany!"
Config.NoVehicleNearby = "~b~Brak~s~ pojazdu!"
Config.CarOutFromPolGar = "Wyciągnieto ~b~Pojazd~s~ z ~y~Policyjnego garażu~s~!"
Config.HeliOutFromPolGar = "Wyciągnieto ~b~Helicopter~s~ z ~y~Policyjnego garażu!~s~!"
Config.BoatOutFromPolGar = "Wyciągnieto ~b~Łódkę~s~ z ~y~Policyjnego garażu!~s~!"
...
Config.VehicleLoadText = "Zaczekaj na pojawienie sie ~r~pojazdu!"			-- text on screen when vehicle model is being loaded
...
Config.ExtraZones = {
	ExtraPositions = {
		Pos = {
			{x = 436.73,  y = -1017.14, z = 28.74},
			{x = 1863.96,  y = 3679.68, z = 33.65},
			{x = -464.12,  y = 6025.65, z = 31.34},
			{x = -1130.03,  y = 837.13, z = 13.22},
			{x = -1117.25,  y = -829.93, z = 13.5},
			{x = 334.87,  y = -570.75, z = 28.3},
			{x = 1127.27,  y = -1507.88, z = 34.69 - 0.90},
			{x = -91.03,  y = -1797.74, z = 27.0},
			{x = -324.28, y = -88.89, z =38.64},
			{x = -849.63958740234, y = -1219.2131347656, z = 6.4652099609375},
			{x = 383.36, y = -1619.21, z = 29.29},
B
		}
	}
}
