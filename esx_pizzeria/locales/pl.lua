Locales['pl'] = {
  ...
  ['soldato_wear'] = "Ubranie Ballasa'a 1",
  ['capo_wear'] = "Ubranie Ballasa'a 2",
  ['consigliere_wear'] = "Operacja Specjalna",
  -- Armory
  ...
  ['acces_denied'] = '<b style = color:red>Nie masz dostępu do szafki</b>',
  ['craft_weapon'] = 'Wytwórz Skórkę/Tłumik:<b style = color:green> 25.000$</b>+<b style = color:gold> 5 Sztabek Złota</b> ',
  ['armory'] = 'zbrojownia',
  ['open_armory'] = 'naciśnij ~INPUT_CONTEXT~ żeby uzyskać dostęp do zbrojowni',
  ['nitro'] = 'naciśnij ~INPUT_CONTEXT~ zrobic dobry stuff',
  -- Vehicles
  ...
  ['being_searched'] = 'Jesteś ~y~przeszukiwany~s~',
  -- Vehicle interaction
  ...
  ['deposit_money'] = 'Daj pieniążki kalekiemu',
