Locales["en"] = {
  ...
  ["wrong_place"] = "Niestety, nie możesz zasadzić tego w tym miejscu.",
  ["doing_action"] = "Pielęgnowanie rośliny...",
  ["how_cancel"] = "Aby przerwać kliknij <button type='button'>X</button>",
