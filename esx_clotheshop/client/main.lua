								...
								ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'save_dressing',
								{
									...
									if data2.current.value == 'yes' then
										ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'outfit_name', {
											...
											menu3.close()
												local nameLength = string.len(data3.value)
											...
											ESX.ShowNotification(('~r~Za duzo znakow!'))
											end
...
function sexmenu()
	TriggerEvent('esx_skin:OpenSexMenu', function(data, menu)
		menu.close()	
	TriggerEvent('skinchanger:getSkin', function(skin)
		TriggerServerEvent('esx_skin:save', skin)
		end)
...
function Menu()
	...
	local elements = {
			   {label = 'Przeglądaj ubrania z sklepu', value = 'kup'},
			   {label = 'Wybierz ubranie z mieszkania', value = 'wybierz'},
			   {label = 'Usuń ubranie z mieszkania', value = 'remove_cloth'}
		   }
   ...
   ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'dania',
   {
	   ...
	   elements = elements
		   ...
		   if data.current.value == 'kup' then
			   OpenShopMenu()
		   elseif data.current.value == 'wybierz' then
