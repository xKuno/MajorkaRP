...
Config.Weapons = {
  ...
  WEAPON_BAYONET = { item = 'bayonet', label = _U('weapon_knife') },
  ...
  WEAPON_LUGER = { item = 'luger', label = _U('weapon_luger') },
  WEAPON_NAMBU = { item = 'nambu', label = _U('weapon_nambu') },
  WEAPON_DEAGLE = { item = 'deagle', label = _U('weapon_deagle') },
  WEAPON_PISTOL = { item = 'pistol', label = _U('weapon_pistol') },
  WEAPON_GLOCK = { item = 'glock', label = _U('weapon_glock') },
  ...
  WEAPON_AK47NEON = { item = 'ak47neon', label = _U('weapon_assaultrifle') },
