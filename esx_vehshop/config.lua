...
Config.UseLokalneShop = true -- true = Use Lokalne Shop | false = Does Opposite
Config.UseLokalneBlip = true -- true = Use Lokalne Blip | false = Does Opposite
Config.LokalneBlip = {Coords = vector3(900.4, -1155.0, 24.1), Sprite = 67, Color = 2, Display = 4, Scale = 1.0}
...
Config.LicenseEnable = false -- Requires licenses to buy Aircrafts, Boats, Cars, & Lokalnes.
...
Config.Zones = {
	...
	ShopOutsideLokalne = {
		Pos     = vector3(917.14288330078, -1167.9428710938, 24.5),
		Size    = {x = 1.5, y = 1.5, z = 1.0},
		Heading = 166.53,
		Type    = -1,
		ShopId  = 6
	},
	ResellVehicleLokalne = {
