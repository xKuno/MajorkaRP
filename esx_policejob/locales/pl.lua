Locales['pl'] = {
  ...
  -- Vehicles
  --revive
  ['revive player'] = 'Rozpocznij pierwszą pomoc',
  ['revive_inprogress'] = 'RKO w toku',
  ['revive_complete'] = 'Udało się uratować mu życie!',
  ['isdead'] = 'Człowiek nieprzytomny',
  -- koniec revive
  ...
  ['gsr_test'] = 'Sprawdzanie prochu strzelniczego',
  ['search'] = 'przeszukaj',
  ...
  ['being_searched'] = 'Jesteś ~y~przeszukiwany~s~ przez ~y~Policje~s~',
  -- Vehicle interaction
  ...
  ['Prace Spoleczne'] = 'Prace Społeczne',
  -- ID Card Menu
  ['name'] = 'name: %s',
  ['job'] = 'praca: %s',
  ['sex'] = 'płeć: %s',
  ...
  ['confiscate_weapon'] = 'skonfiskuj %s %s',
  ...
  ['you_confiscated_weapon'] = 'skonfiskowałeś ~b~%s~s~ od ~b~%s~s~',
  ['got_confiscated_weapon'] = 'twój ~b~%s~s~ ~o~%s~s~został skonfiskowany przez ~y~%s~s~',
