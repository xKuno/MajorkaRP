...
Config.NPCNextToDistance          = 100.0
Config.NPCJobEarnings             = { min = 850, max = 1250 }
Config.Locale                     = 'pl'
...
Config.Zones = {
	...
	MecanoActions = {
		Pos   = { x = -340.0, y = -157.36, z = 44.59 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 233, g = 234, b = 0 },
		Type  = 22,
	},


	Craft = {
		Pos   = { x = 12381283.312, y = -31231.33, z = 12312.55 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
...
--- warsztat starego
	...
	Garage = {
		Pos   = { x = 89.17, y = -2563.76, z = 6.0-0.8 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1,
	},
