...
AddEventHandler("mkbuss:open5mscriptscom", function(data)
	...
	if draw[random].item then
		TriggerServerEvent('mkbuss:giveReward', 'item',draw[random].item,draw[random].amount, pizda)
        print(pizda)
	elseif draw[random].weapon then
		TriggerServerEvent('mkbuss:giveReward', 'weapon',draw[random].weapon, pizda)
        print(pizda)
	elseif draw[random].vehicle then
		TriggerEvent('mkbuss:RewardVehicle', draw[random].vehicle)
	elseif draw[random].money then
		TriggerServerEvent('mkbuss:giveReward', 'money',draw[random].money, pizda, pizda)
        print(pizda)
