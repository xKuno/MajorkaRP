Locales['en'] = {
  ...
  ['wear_work'] = 'strój pracownika Winiarni',

  -- skup
  ['sell_menu'] = 'Skup winogron',
  ['sell_prompt'] = 'naciśnij ~INPUT_CONTEXT~ aby otworzyć ~y~sklep~s~.',
  ['sell_apple'] = 'Sprzedaj winogrona',
  ['sell_orange'] = 'Sprzedaj pomarańcze',

  -- przerobka
  ['juice_menu'] = 'Hurtownia wina',
  ...
  ['juice_maker'] = 'Przerób winogrona na wino <span style="color:red">KOSZT: 1$</span>',
  ...
  ['only_vigne'] = 'możesz przechowywać tylko autoryzowane auta.',
  ...
  ['must_in_vigne'] = 'musisz być w taksówce aby rozpocząć misję',
